...
- v0.3.6 is one-way upload only, not two-way sync.
- v0.3.6 does not propagate local deletions to pCloud.
- v0.3.6 uses a fresh SQLite state database and does not migrate legacy `state.json` task or file caches.
